...
finishBtn.addEventListener("click", async () => {
  ...
  */
  ...
  const finishJson = {
    food: parseFloat(starList[0].value)/2 + 0.0,
    amenities: parseFloat(starList[1].value)/2 + 0.0,
    restRoom: parseFloat(starList[2].value)/2 + 0.0,
    vibe: parseFloat(starList[3].value)/2 + 0.0,
