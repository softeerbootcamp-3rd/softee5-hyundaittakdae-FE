...
const finishBtn = document.querySelector("#writeContinueBtn");
const notFinishBtn = document.querySelector("#writeReviewBtn");
...
notFinishBtn.addEventListener("click", ()=>{
    ...
    if(starList[0].value === '0' || starList[1].value === '0' || starList[2].value === '0' || starList[3].value === '0'){
